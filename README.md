...
InfinityMix now treats `app/` as the authoritative automation runtime.
Legacy services in `services/analyzer`, `services/renderer`, and `services/worker` are deprecated and excluded from default Docker Compose startup.
They can only be started explicitly with the `legacy-services` profile for debugging.
...
---
Generated: 2025-11-28T04:29:11.053Z
Project: InfinityMix
